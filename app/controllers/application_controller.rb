class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.for(:account_update) { |u| u.permit(:first_name, :last_name, :word1, :word2, :word3, :city, :phone, :email, :password, :password_confirmation, :current_password, :about, :avatar, :avatar_cache, :remove_avatar, :achievement1, :achievement2, :achievement3, :title1, :description1, :link1, :title2, :description2, :link2, :title3, :description3, :link3, :skill1, :skill2, :skill3, :name, :description, :link, :logo, :logo_cache, :remove_logo) }
  end
end
